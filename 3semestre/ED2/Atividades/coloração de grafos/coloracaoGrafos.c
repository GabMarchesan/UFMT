...
void algoritmoDsatur(GRAFO* g) {
    ...
    // Encontrar o número cromático
    int chromatic_number = -1;
    for (int i = 0; i < g->vertices; i++) {
        if (colors[i] > chromatic_number) {
            chromatic_number = colors[i];
        }
    }
...
int main() {
    ...
    //printf("\nGRAFO:\n");
    //imprime(grafoMiles250);
    algoritmoDsatur(grafoMiles250);
    ...
    //printf("\nGRAFO:\n");
    //imprime(grafoMiles1000);
    algoritmoDsatur(grafoMiles1000);
