...
{
      -6,     0,    -6,    -5,    -6,    23,    -6,    13,    23,    -6,
      -2,    23,    23,    23,    23,    -6,    20,    -6,    15,    15,
      -6,    -6,    -6
};
...
{
       2,    11,    12,    13,    14,     8,    10,     3,     4,    16,
      17,     5,    18,    19,    20,    21,    11,    12,    13,    14,
      13,    14,    15,    11,    12,    13,    14,     0,     0,    22,
       9,     4,     0,     0,     5
};
...
#line 49 "calc.y"
        ...
        printf("%s", (yyvsp[0].attribute).code); 
      }
...
#line 62 "calc.y"
        {
             ...
             */
            sprintf((yyval.attribute).code, "%s%s = %s\n", (yyvsp[-1].attribute).code, (yyvsp[-3].attribute).temp, (yyvsp[-1].attribute).temp);
        }
...
#line 73 "calc.y"
        {
            ...
            sprintf((yyval.attribute).code, "%s = %s\n", (yyval.attribute).temp, (yyvsp[0].attribute).temp);
        }
...
#line 79 "calc.y"
        {
            ...
            strcpy((yyval.attribute).code, ""); // Nenhum código é gerado
        }
...
#line 85 "calc.y"
        {
            ...
            sprintf((yyval.attribute).code, "%s%s%s = %s + %s\n", (yyvsp[-2].attribute).code, (yyvsp[0].attribute).code, (yyval.attribute).temp, (yyvsp[-2].attribute).temp, (yyvsp[0].attribute).temp);
        }
