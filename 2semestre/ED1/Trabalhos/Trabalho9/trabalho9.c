...
// Função para percorrer e imprimir a árvore em pré-ordem
...
int main() {
    ...
    printf("Árvore percorrendo linha por linha (Pré-ordem): ");
    preorderTraversal(rootRow);
    printf("\nAltura da árvore: %d\n", calculateHeight(rootRow));

    printf("Árvore percorrendo coluna por coluna (Pré-ordem): ");
    preorderTraversal(rootCol);
